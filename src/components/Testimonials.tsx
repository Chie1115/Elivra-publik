...
export default function Testimonials() {
  return (
    <section id="testimonials" className="py-12 md:py-20 bg-[#FFF5F3]">
      <div className="container px-4">
        <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-center mb-8 md:mb-12 text-[oklch(0.58_0.09_220)]">
          Vad våra kunder säger
        </h2>
        <p className="text-sm md:text-base text-center max-w-3xl mx-auto mb-8 md:mb-12 leading-relaxed px-4">
          Läs vittnessmål från familjer som har upplevt Elivra-skillnaden. Upptäck hur vår omsorgsfulla vård och dedikerade support har haft en positiv inverkan på deras nära och käras liv.
        </p>
        ...
        <div className="grid md:grid-cols-3 gap-6 md:gap-8 max-w-6xl mx-auto">
          <div className="bg-white border border-gray-200 rounded-lg p-6 md:p-8 shadow-sm flex flex-col">
